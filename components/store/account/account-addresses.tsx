...
export function AccountAddresses() {
  ...
  async function handleSaveAddress(
    ...
    const response =
      await fetch(
        editingAddress
          ? `/api/store/checkout/addresses/${editingAddress.id}`
          : "/api/store/checkout/addresses",
        {
          method:
            editingAddress
  ...
  async function handleSetDefault(
    ...
    await fetch(
      `/api/store/checkout/addresses/${id}`,
      {
        method:
          "PATCH",
  ...
  async function handleDelete() {
    ...
    await fetch(
      `/api/store/checkout/addresses/${deleteAddress.id}`,
      {
        method:
          "DELETE",
      }
    ...
    <>
      <div className="mx-auto max-w-[1100px] px-4 py-6 sm:px-6 sm:py-8 lg:px-8 lg:py-10">
          ...
          >
            ...
            >
              <button
                ...
                className="group flex min-h-[230px] w-full flex-col items-center justify-center rounded-2xl border-2 border-dashed border-border bg-background p-6 text-center transition-colors hover:border-primary/40 hover:bg-primary/5 sm:rounded-3xl"
              >
        ...
        <Reveal
          ...
          className="mt-6"
        >
          <section className="rounded-2xl border border-primary/15 bg-primary/5 p-4 sm:rounded-3xl sm:p-5">
...
function AddressCard({
  ...
  return (
    <article
      className={`relative h-full overflow-hidden rounded-2xl border bg-background p-4 shadow-sm sm:rounded-3xl sm:p-5 ${
        address.isDefault
          ? "border-primary/40"
          : "border-border"
      }`}
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-end justify-center bg-black/60 sm:items-center sm:p-4">
      ...
      <Reveal
        ...
        scaleFrom={0.94}
        duration={0.45}
        className="relative z-10 w-full sm:max-w-[680px]"
      >
        <div className="max-h-[94dvh] w-full overflow-y-auto rounded-t-3xl bg-background shadow-2xl sm:rounded-3xl">
...
function DeleteAddressModal({
  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-center justify-center bg-black/60 p-4">
      ...
      >
        <div className="w-full rounded-3xl bg-background p-5 shadow-2xl sm:p-6">
