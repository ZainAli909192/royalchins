    ...
    return (
      <div className="mx-auto max-w-[1100px] px-4 py-16 sm:px-6 lg:px-8">
        <AdminPageLoader
          ...
          className="min-h-[440px] rounded-3xl bg-background shadow-sm"
        />
      </div>
    );
  }
        ...
        <section className="overflow-hidden rounded-3xl border border-border bg-background shadow-sm">
          ...
          <div className="p-4 sm:p-6 lg:p-8">
            ...
            <Reveal
              ...
              className="mt-6"
            >
              <div className="flex flex-col gap-3 border-t border-border pt-6 sm:flex-row sm:items-center sm:justify-center">
                <Button
                  asChild
                  variant="primary"
