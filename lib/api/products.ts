...
export type ProductResponse = Omit<
  ProductApiValues,
  "mainCategory" | "subCategory" | "images"
> & {
  id: string;
  categoryId: string;
  category: {
...
export const getProducts = () =>
  apiRequest<ProductResponse[]>("/api/admin/products");

export const getProduct = (id: string) =>
  apiRequest<ProductResponse>(`/api/admin/products/${id}`);

export const createProduct = (payload: ProductApiValues) =>
  apiRequest<ProductResponse>("/api/admin/products", {
    method: "POST",
