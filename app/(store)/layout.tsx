...
export const metadata: Metadata = {
  title: {
    absolute:
      "Royal Chins | Chinchillas, Guinea Pigs & Small Pets UAE",
  },
  description:
    "Discover Chinchillas, Guinea Pigs, Micro Squirrels and carefully selected small pet accessories from Royal Chins in the UAE.",
  alternates: {
    canonical: "/",
  },
};
