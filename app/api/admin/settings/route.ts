...
const defaults = {
  brand: { storeName: "Royal Chins", logo: "/logo.png", primaryColor: "#6F3CC3", secondaryColor: "#000000", textColor: "#000000" },
  adminBrand: { storeName: "Royal Chins Admin", logo: "/logo.png", primaryColor: "#6F3CC3", secondaryColor: "#000000", textColor: "#000000" },
...
export async function GET(request: Request) {
  ...
  return NextResponse.json({ brand: { ...defaults.brand, ...saved.brand }, adminBrand: { ...defaults.adminBrand, ...saved.adminBrand }, contact: { ...defaults.contact, ...saved.contact }, inventory: { ...defaults.inventory, ...saved.inventory }, reviews: { ...defaults.reviews, ...saved.reviews } });
}
